                ...
                <div className="itemDetailSpecs dropShadow" >
                    <div className="itemDetailInfo">
                        ...
                        <div className="itemDescription">
                            <h3 className='itemDescriptionTitle' >Descripcion Producto:</h3>
                            {props.object.description}
                        </div>
                        <h3>Precio: ${props.object.price}</h3>
                    </div>
                    <div className="itemDetailButtons">
                        ...
                        {buttonHide || <Link className="styleRemove" to="/cart/"><Button id="purchaseButton" variant="contained" color="inherit">Terminar la Compra</Button></Link>}
                    </div>
                </div>
            </div>
        </>
